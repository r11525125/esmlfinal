...
module dma_exp_0 (
    ...
    EfxDMA_48cdbe43d9ab4477bd42fdd90788f707 EfxDMA_u  (
        .clk ( clk ),
        .reset ( reset ),
...
// Component : EfxDMA_48cdbe43d9ab4477bd42fdd90788f707



module EfxDMA_48cdbe43d9ab4477bd42fdd90788f707 (
  input      [13:0]   ctrl_PADDR,
  input      [0:0]    ctrl_PSEL,
  input               ctrl_PENABLE,
  output              ctrl_PREADY,
  ...
  EfxDMA_Core_48cdbe43d9ab4477bd42fdd90788f707 core (
  ...
  EfxDMA_BmbArbiter_48cdbe43d9ab4477bd42fdd90788f707 interconnect_read_aggregated_arbiter (
  ...
  EfxDMA_BmbArbiter_1_48cdbe43d9ab4477bd42fdd90788f707 interconnect_write_aggregated_arbiter (
  ...
  EfxDMA_BmbSourceRemover_48cdbe43d9ab4477bd42fdd90788f707 readLogic_sourceRemover (
  ...
  EfxDMA_BmbToAxi4ReadOnlyBridge_48cdbe43d9ab4477bd42fdd90788f707 readLogic_bridge (
  ...
  EfxDMA_BmbSourceRemover_1_48cdbe43d9ab4477bd42fdd90788f707 writeLogic_sourceRemover (
  ...
  EfxDMA_BmbToAxi4WriteOnlyBridge_48cdbe43d9ab4477bd42fdd90788f707 writeLogic_bridge (
  ...
  EfxDMA_StreamFifoCC_48cdbe43d9ab4477bd42fdd90788f707 inputsAdapter_0_crossclock_fifo (
  ...
  EfxDMA_StreamFifoCC_1_48cdbe43d9ab4477bd42fdd90788f707 outputsAdapter_0_crossclock_fifo (
...
module EfxDMA_StreamFifoCC_1_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_push_valid,
  ...
  EfxDMA_BufferCC_1_48cdbe43d9ab4477bd42fdd90788f707 popToPushGray_buffercc (
    .io_dataIn     (popToPushGray[4:0]                      ), //i
    .io_dataOut    (popToPushGray_buffercc_io_dataOut[4:0]  ), //o
    .clk           (clk                                     ), //i
    .reset         (reset                                   )  //i
  );
  EfxDMA_BufferCC_3_48cdbe43d9ab4477bd42fdd90788f707 pushToPopGray_buffercc (
...
module EfxDMA_StreamFifoCC_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_push_valid,
  output              io_push_ready,
  input      [31:0]   io_push_payload_data,
  input      [3:0]    io_push_payload_mask,
  ...
  EfxDMA_BufferCC_48cdbe43d9ab4477bd42fdd90788f707 popToPushGray_buffercc (
    .io_dataIn       (popToPushGray[4:0]                      ), //i
    .io_dataOut      (popToPushGray_buffercc_io_dataOut[4:0]  ), //o
    .dat1_i_clk      (dat1_i_clk                              ), //i
    .dat1_i_reset    (dat1_i_reset                            )  //i
  );
  EfxDMA_BufferCC_1_48cdbe43d9ab4477bd42fdd90788f707 pushToPopGray_buffercc (
    .io_dataIn     (pushToPopGray[4:0]                      ), //i
    .io_dataOut    (pushToPopGray_buffercc_io_dataOut[4:0]  ), //o
    .clk           (clk                                     ), //i
    .reset         (reset                                   )  //i
...
module EfxDMA_BmbToAxi4WriteOnlyBridge_48cdbe43d9ab4477bd42fdd90788f707 (
  ...
  EfxDMA_BmbContextRemover_1_48cdbe43d9ab4477bd42fdd90788f707 contextRemover (
  ...
  EfxDMA_StreamFork_2_48cdbe43d9ab4477bd42fdd90788f707 contextRemover_io_output_cmd_fork (
...
module EfxDMA_BmbSourceRemover_1_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
...
module EfxDMA_BmbToAxi4ReadOnlyBridge_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_opcode,
  ...
  EfxDMA_BmbContextRemover_48cdbe43d9ab4477bd42fdd90788f707 contextRemover (
    .io_input_cmd_valid                        (io_input_cmd_valid                                           ), //i
    .io_input_cmd_ready                        (contextRemover_io_input_cmd_ready                            ), //o
    .io_input_cmd_payload_last                 (io_input_cmd_payload_last                                    ), //i
    .io_input_cmd_payload_fragment_opcode      (io_input_cmd_payload_fragment_opcode                         ), //i
...
module EfxDMA_BmbSourceRemover_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_source,
...
module EfxDMA_BmbArbiter_1_48cdbe43d9ab4477bd42fdd90788f707 (
  ...
  EfxDMA_StreamArbiter_1_48cdbe43d9ab4477bd42fdd90788f707 memory_arbiter (
...
module EfxDMA_BmbArbiter_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_inputs_0_cmd_valid,
  output              io_inputs_0_cmd_ready,
  input               io_inputs_0_cmd_payload_last,
  input      [0:0]    io_inputs_0_cmd_payload_fragment_opcode,
  ...
  assign _zz_6 = {memory_arbiter_io_output_payload_fragment_source,memory_arbiter_io_chosen};
  EfxDMA_StreamArbiter_48cdbe43d9ab4477bd42fdd90788f707 memory_arbiter (
    .io_inputs_0_valid                       (io_inputs_0_cmd_valid                                    ), //i
    .io_inputs_0_ready                       (memory_arbiter_io_inputs_0_ready                         ), //o
    .io_inputs_0_payload_last                (io_inputs_0_cmd_payload_last                             ), //i
    .io_inputs_0_payload_fragment_source     (_zz_1                                                    ), //i
...
module EfxDMA_Core_48cdbe43d9ab4477bd42fdd90788f707 (
  ...
  EfxDMA_DmaMemoryCore_48cdbe43d9ab4477bd42fdd90788f707 memory_core (
  ...
  EfxDMA_Aggregator_48cdbe43d9ab4477bd42fdd90788f707 b2m_fsm_aggregate_engine (
...
module EfxDMA_BufferCC_3_48cdbe43d9ab4477bd42fdd90788f707 (
  input      [4:0]    io_dataIn,
...
//EfxDMA_BufferCC_1_48cdbe43d9ab4477bd42fdd90788f707 replaced by EfxDMA_BufferCC_1_48cdbe43d9ab4477bd42fdd90788f707

module EfxDMA_BufferCC_1_48cdbe43d9ab4477bd42fdd90788f707 (
  input      [4:0]    io_dataIn,
  output     [4:0]    io_dataOut,
  input               clk,
  input               reset
...
module EfxDMA_BufferCC_48cdbe43d9ab4477bd42fdd90788f707 (
  input      [4:0]    io_dataIn,
  output     [4:0]    io_dataOut,
  input               dat1_i_clk,
  input               dat1_i_reset
...
module EfxDMA_StreamFork_2_48cdbe43d9ab4477bd42fdd90788f707 (
...
module EfxDMA_BmbContextRemover_1_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_opcode,
  ...
  EfxDMA_StreamFork_1_48cdbe43d9ab4477bd42fdd90788f707 io_input_cmd_fork (
  ...
  EfxDMA_StreamFifo_1_48cdbe43d9ab4477bd42fdd90788f707 io_input_cmd_fork_io_outputs_0_thrown_translated_fifo (
...
module EfxDMA_BmbContextRemover_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_opcode,
  ...
  assign _zz_5 = (! io_input_cmd_fork_io_outputs_0_payload_first);
  EfxDMA_StreamFork_48cdbe43d9ab4477bd42fdd90788f707 io_input_cmd_fork (
    .io_input_valid                           (io_input_cmd_valid                                             ), //i
    .io_input_ready                           (io_input_cmd_fork_io_input_ready                               ), //o
    .io_input_payload_last                    (io_input_cmd_payload_last                                      ), //i
    .io_input_payload_fragment_opcode         (io_input_cmd_payload_fragment_opcode                           ), //i
  ...
  EfxDMA_StreamFifo_48cdbe43d9ab4477bd42fdd90788f707 io_input_cmd_fork_io_outputs_0_thrown_translated_fifo (
    .io_push_valid      (io_input_cmd_fork_io_outputs_0_thrown_translated_valid                      ), //i
    .io_push_ready      (io_input_cmd_fork_io_outputs_0_thrown_translated_fifo_io_push_ready         ), //o
...
module EfxDMA_StreamArbiter_1_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_inputs_0_valid,
...
module EfxDMA_StreamArbiter_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_inputs_0_valid,
  output              io_inputs_0_ready,
  input               io_inputs_0_payload_last,
  input      [0:0]    io_inputs_0_payload_fragment_source,
...
module EfxDMA_Aggregator_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_input_valid,
...
module EfxDMA_DmaMemoryCore_48cdbe43d9ab4477bd42fdd90788f707 (
...
module EfxDMA_StreamFifo_1_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_push_valid,
  output              io_push_ready,
...
module EfxDMA_StreamFork_1_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_input_valid,
  output reg          io_input_ready,
  input               io_input_payload_last,
  input      [0:0]    io_input_payload_fragment_opcode,
...
module EfxDMA_StreamFifo_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_push_valid,
  output              io_push_ready,
...
module EfxDMA_StreamFork_48cdbe43d9ab4477bd42fdd90788f707 (
  input               io_input_valid,
  output reg          io_input_ready,
  input               io_input_payload_last,
  input      [0:0]    io_input_payload_fragment_opcode,
